...
import { ADD_NEW_FILM_SAGA } from "../../redux/sagas/contants/manageFilmContants";
function FormAddNewFilm(props) {
  ...
  return (
    <form onSubmit={callBackSubmit}>
      ...
      <div>
        ...
        />
        {errors && touched.top && (
          <p className="text-red-600 mx-2 mt-1 font-sans">{errors.top}</p>
        )}
      </div>
      <div>
